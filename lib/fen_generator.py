...
def generate_odds_fen(opponent_elo, pawn_to_elo=PAWN_TO_ELO, variation_std=STD, max_variation=MAX_VARIATION, base_elo=BASE_ELO):
    """
    ...
    effective_elo = opponent_elo + elo_adjustment
